...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=coverage)](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=coverage)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=bugs)](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=bugs)

[![Security](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=security_rating)](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=security_rating)
[![Maintainability](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=sqale_rating)](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=sqale_rating)
[![Reliability](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=reliability_rating)](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=reliability_rating)
[![Vuns](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=vulnerabilities)](https://sonarcloud.io/api/project_badges/measure?project=Barnstorm-Online_barnstorm-cli&metric=vulnerabilities)
